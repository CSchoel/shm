...
model DiracSignal "Discrete periodic dirac signal"
  SHM.Shared.Connectors.TriggerOutput signal "the generated signal" annotation(Placement(visible = true, transformation(origin = {98.8129,-39.9457}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {97.2839,-39.3723}, extent = {{-10,-10},{10,10}}, rotation = 0)));
equation
  signal.s = sample(0, 1);

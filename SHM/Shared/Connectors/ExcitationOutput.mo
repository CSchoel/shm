...
connector ExcitationOutput = output Boolean "discrete signal for pacemaker"
  annotation(
    ...
    Documentation(info="<html><p>Models a pacemaker signal as real valued discrete signal.</p></html>")
  );

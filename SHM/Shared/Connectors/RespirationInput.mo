...
connector RespirationInput "Respiratory phase input"
  input Real phase "Respiratory phase (0-0.5 => expiration, 0.5-1 => inspiration)";
...
annotation(Documentation(info="<html>
  <p>Models respiratory input as phase that rises from 0 to 1 and is then reset to 0 again (integrate-and-fire).
  The expiration period corresponds to values from 0 to 0.5 and the inspiration period to values from 0.5 to 1.</p>
</html>"));
end RespirationInput;
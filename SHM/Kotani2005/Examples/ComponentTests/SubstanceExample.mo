...
model SubstanceExample "example for substance emissions"
  ...
  SHM.Kotani2005.Components.HormoneEmission hormoneEmission1 "hormone emission" annotation(Placement(transformation(extent = {{-84,31},{-64,51}})));
...
equation
  connect(hormoneEmission1.con,HormoneAmount1.con) annotation(Line(points = {{-74.17,46.17},{-80.1339,46.17},{-80.1339,79.2411},{-80.1339,79.2411}}));

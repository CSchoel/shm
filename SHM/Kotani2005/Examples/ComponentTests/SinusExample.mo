...
model SinusExample "sinus node test"
  ...
  SHM.Kotani2005.Components.HormoneEmission hormoneEmission1 "cVne emission";
...
equation
  ...
  connect(linearNerveSignal2.nerve1,hormoneEmission1.trigger) annotation(Line(points = {{-43.5,40},{-48.5,35},{-58.5,35},{-58.5,60},{-60.83332824707031,60}}, thickness = 0.0625), AutoRoute = false);

...
model HeartExample "heart model test"
  ...
  SHM.Kotani2005.Components.HormoneEmission hormoneEmission1 "cVne emission" annotation(Placement(visible = true, transformation(origin = {70.7424,64.6422}, extent = {{-10,-10},{10,10}}, rotation = 0)));
  SHM.Kotani2005.Components.HormoneEmission hormoneemission1 "cCne emission" annotation(Placement(visible = true, transformation(origin = {31.6964,54.4643}, extent = {{-10,-10},{10,10}}, rotation = 0)));
...
equation
  ...
  connect(hormoneemission1.con,HormoneAmount1.con) annotation(Line(points = {{31.5264,59.6343},{24.3304,59.6343},{24.3304,80.3571},{24.3304,80.3571}}));
  connect(linearNerveSignal1.nerve1,hormoneemission1.trigger) annotation(Line(points = {{49.3488,9.63327},{31.6964,9.63327},{31.6964,49.1071},{31.6964,49.1071}}));

...
model KotaniFullExample 
  ...
  SHM.Kotani2005.Components.HormoneEmission vNeEmit(Tuptake = vNe_Tuptake, prodFac = vNe_fac_symp, triggerDelay = vNe_delay, baseSignal = vNe_base_activity) "emission of vascular Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-20, 40}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  SHM.Kotani2005.Components.NeurotransmitterEmission cNeEmit(Tuptake = cNe_Tuptake, prodFac = cNe_fac_symp, triggerDelay = cNe_delay) "emission of cardiac Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-60, 40}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));

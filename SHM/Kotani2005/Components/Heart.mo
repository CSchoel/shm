...
model Heart "main heart model"
  ...
  SHM.Shared.Connectors.TriggerInput sinusSignal "discrete signal from the sinus node" annotation(Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

...
model Heart "main heart model"
  ...
  SHM.Shared.Components.Saturation satS(sat=maxS,satexp=satExpS) "saturation function for contractility";
  SHM.Shared.Components.Saturation satCvne(sat=maxCvne,satexp=satExpCvne) "saturation function for vascular concentration of Norepinephrine";
  SHM.Shared.Connectors.DiscreteSignal sinusSignal "discrete signal from the sinus node" annotation(Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  SHM.Shared.Connectors.HormoneConcentration cvne "vascular concentration of Norepineprhine" annotation(Placement(visible = true, transformation(origin = {0, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  SHM.Shared.Connectors.NeurotransmitterConcentration ccne "cardiac concentration of Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-60, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Real pdia "diastolic blood pressure";
  Real rdia "rate of change of diastolic blood pressure";
  Real psys "systolic blood pressure";
  Real rsys "rate of change of systolic blood pressure";
protected
  ...
  Boolean systole = time - tlast < Tsys "true during systole, false during diastole";
initial equation
  S = initialS;
  tlast = initialTlast;
  plast = initialPlast;
...
annotation(Documentation(info="<html>
  <p>Models the heart in the Version of Kotani et. al. (2005).</p>
  <p>Systolic blood pressure and diastolic blood pressure are modeled as separate formulas, which are switched each time the systole ends and each time a new heart beat is produced.</p>

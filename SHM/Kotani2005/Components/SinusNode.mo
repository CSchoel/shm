...
model SinusNode "sinus node integrate-and-fire model"
  SHM.Shared.Connectors.DiscreteSignal signal "generated signal" annotation(Placement(visible = true, transformation(origin = {0, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

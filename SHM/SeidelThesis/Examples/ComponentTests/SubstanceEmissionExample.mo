...
model SubstanceEmissionExample
  SHM.SeidelThesis.Components.SubstanceEmission cVne(tau=4,k_ex=0.014,k_in=0.006,delay_ex=2,delay_in=0.4,with_inhibition=true) "cVne";
  SHM.SeidelThesis.Components.SubstanceEmission  cAc(tau=0.05,k_ex=0.005,delay_ex=0.4,with_inhibition=false) "cAc";

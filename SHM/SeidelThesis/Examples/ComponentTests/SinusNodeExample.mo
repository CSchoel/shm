...
model SinusNodeExample
  ...
  SHM.SeidelThesis.Components.SubstanceRelease cNeEmit(tau=2,k_ex=0.014,k_in=0.006,delay_ex=2,delay_in=0.4,with_inhibition=true) "cNe";
  SHM.SeidelThesis.Components.SubstanceRelease cAcEmit(tau=0.05,k_ex=0.005,delay_ex=0.4,with_inhibition=false) "cAc";

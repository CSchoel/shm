...
model Heart "Main heart model"
  ...
  SHM.Shared.Connectors.TriggerInput sinus "sinus node signal" annotation(Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-50, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

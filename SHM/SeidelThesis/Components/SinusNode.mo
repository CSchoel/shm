...
model SinusNode "Sinus node"
  ...
  SHM.Shared.Connectors.DiscreteSignal signal "output signal generated by the sinus node" annotation(Placement(visible = true, transformation(origin = {0, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
protected

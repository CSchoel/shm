...
model SinusNode "Sinus node"
  ...
  parameter Real k_cNe = 1.2 "sensitivity of sinus node to concentration of Norepinephrine";
  parameter Real k_cAc = 0.2 "sensitivity of sinus node to concentration of Acetylcholine";
...
protected
  ...
  Boolean signal0 "base signal of the sinus node";
equation

...
model Baroreceptors "baroreceptors measuring blood pressure"
  ...
  SHM.SeidelThesis.Components.Broaden broad(len=broad_len,resolution=broad_res,eta=broad_eta,sigma=broad_sigma) if broadened "broadening function";
protected
...
equation
  ...
  signal.activation = if broadened then broad.xbroad else sat_signal;

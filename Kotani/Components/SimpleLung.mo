...
model SimpleLung
  Kotani.Components.Basic.RespirationOutput resp annotation(Placement(visible = true, transformation(origin = {0.0,-102.7206}, extent = {{-14.85,-10.5},{14.85,10.5}}, rotation = 0), iconTransformation(origin = {0.0,-97.8291}, extent = {{-10.0,-10.0},{10.0,10.0}}, rotation = 0)));

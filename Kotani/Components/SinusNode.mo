...
model SinusNode "SinusNode"
	Kotani.Components.Basic.Nerve parasympathicus annotation(Placement(
		transformation(
			origin={100,100},
			extent={{-10,-10},{10,10}}),
		iconTransformation(
			origin={50,50},
			extent={{-10,-10},{10,10}})));
	Kotani.Components.Basic.Nerve phase annotation(Placement(
		transformation(
			origin={-54.9,-74.8},
			extent={{-10,-10},{10,10}}),
		iconTransformation(
			origin={0,-100},
			extent={{-10,-10},{10,10}})));
	Kotani.Components.Basic.HormoneConcentration ccne "Cardiac Concentration of Norepinephrine" annotation(Placement(
		transformation(
			origin={-139.9,9.9},
			extent={{-10,-10},{10,10}}),
		iconTransformation(
		...
		Icon(
			...
			graphics={
							Text(
								...
								extent={{-16.7204,-16.4585},{16.7204,16.4585}},
								visible=true,
								origin={-83.2796,83.5415}),
							Text(
								textString="P",
								fillPattern=FillPattern.Solid,
								extent={{-16.5365,-16.3527},{16.5365,16.3527}},
								visible=true,
								origin={83.4635,83.6473}),
							Line(
								points={{41.765,44.267},{8.380000000000001,-18.204},{-1.91,27.731},{-48.235,-53.794}},
								color={128,128,0},
								thickness=1,
								visible=true,
								origin={3.2,-14.1}),
							Line(
								points={{16.054,3.333},{-8.957000000000001,-16.667},{-7.097,13.333}},
								color={128,128,0},
								thickness=1,
								visible=true,
								origin={-36,-51.2}),
							Ellipse(
								...
								extent={{-79.375,-79.375},{79.375,79.375}},
								visible=true,
								origin={0.8,-10.7})}),
		Diagram(
			coordinateSystem(grid={10,10}),

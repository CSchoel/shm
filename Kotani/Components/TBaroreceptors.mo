...
model TBaroreceptors
  ...
  Kotani.Components.Basic.TSaturation sat(
...
equation
  ...
  signal.activation = if broadened then Kotani.Functions.Broaden(sat_signal,eta=0.15,sigma=0.11) else sat_signal;

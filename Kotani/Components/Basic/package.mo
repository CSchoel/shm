...
package Basic 
  connector BloodVessel "Blood vessel propagating blood pressure"
    ...
    annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Rectangle(visible=true, origin={-0.0,-0.2067}, fillColor={128,0,0},
            fillPattern =                                                                                                    FillPattern.Solid, extent={{-100.0,-27.0785},{100.0,27.0785}})}));
  end BloodVessel;
  ...
  equation
    ...
    annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Ellipse(visible=true, fillColor={128,0,0},
            fillPattern =                                                                                                    FillPattern.Solid, extent={{-82.6823,-83.2796},{82.6823,83.2796}})}), Diagram(coordinateSystem(extent={{-148.5,-105.0},{148.5,105.0}}, preserveAspectRatio=true, initialScale=0.1, grid={5,5})));
  end BloodSystem;
  ...
  equation
    ...
    annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Rectangle(visible=true, origin={-66.0563,-0.0}, fillColor={0,0,255},
            fillPattern =                                                                                                    FillPattern.Solid, extent={{-36.0563,-10.0},{36.0563,10.0}}),Rectangle(visible=true, origin={64.8437,-0.0}, fillColor={0,0,255},
            fillPattern =                                                                                                    FillPattern.Solid, extent={{-34.8437,-10.0},{34.8437,10.0}})}), Diagram(coordinateSystem(extent={{-148.5,-105.0},{148.5,105.0}}, preserveAspectRatio=true, initialScale=0.1, grid={5,5})));
  end NerveSystem;
  ...
  connector RespiratoryPhase
    ...
    annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Ellipse(visible=true, fillColor={255,255,255},
            fillPattern =                                                                                                    FillPattern.Solid, extent={{-77.5146,-77.4919},{77.5146,77.4919}})}), Diagram(coordinateSystem(extent={{-148.5,-105.0},{148.5,105.0}}, preserveAspectRatio=true, initialScale=0.1, grid={5,5})));

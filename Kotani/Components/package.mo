...
package Components
  ...
  model SimpleLung
    ...
    Kotani.Components.Basic.NerveFiber baro annotation(Placement(visible=true, transformation(origin={-147.9538,0.4341}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0), iconTransformation(origin={-100.0,-0.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));

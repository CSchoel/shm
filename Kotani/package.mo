package Kotani
  package Examples
    ...
    model SinusExample
      ...
      Kotani.Components.Basic.LinearNerveSignal linearNerveSignal1 annotation(Placement(visible=true, transformation(origin={-110.0,65.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      Kotani.Components.Basic.NerveSystem nerveSystem2 annotation(Placement(visible=true, transformation(origin={-2.6225,47.4694}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
    ...
    equation 
      ...
      connect(nerveSystem2.fiber,sinusNode1.parasympathicus) annotation(Line(visible=true, origin={-6.4587,33.1886}, points={{2.8362,14.2808},{2.8362,-2.3118},{-2.8362,-2.3118},{-2.8362,-9.6572}}));

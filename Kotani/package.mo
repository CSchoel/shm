package Kotani
  package Examples
    ...
    model SympatheticSystem
      ...
      Kotani.Components.Basic.LinearBloodPressure linearBloodPressure1 annotation(Placement(visible=true, transformation(origin={-110.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      ...
      Kotani.Components.SuperSimpleLung simpleLung1 annotation(Placement(visible=true, transformation(origin={0.0,72.3713}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
    ...
    equation 
      connect(simpleLung1.resp,respiratorySystem1.phase) annotation(Line(visible=true, origin={1.6667,53.0278}, points={{-1.6667,9.5606},{-1.6667,-4.7803},{15.2788,-3.0278}}));
      connect(simpleLung1.baro,nerveSystem2.fiber) annotation(Line(visible=true, origin={-30.0,68.6857}, points={{20.0,3.6857},{-2.0,3.6857},{-2.0,-3.6857},{-16.0,-3.6857}}));
      ...
      connect(linearBloodPressure1.vessel,bloodSystem1.vessel) annotation(Line(visible=true, origin={-115.8544,-12.0145}, points={{5.8544,-17.9855},{5.8544,-4.9855},{-4.9029,-4.9855},{-4.9029,13.9783},{-1.9029,13.9783}}));

...
model SinusExample
  ...
  Components.Basic.NerveSystem nerveSystem3 annotation(Placement(transformation(origin = {-20,-20}, extent = {{-10,-10},{10,10}})));
...
equation
  ...
  connect(sinusNode1.phase,nerveSystem3.fiber) annotation(Line(points = {{-14.8,8},{-14.8,3},{-25.8,3},{-25.8,-20},{-20.8,-20}}, thickness = 0.0625));
  ...
  annotation(sinusNode1(phase(activation(flags = 2))), Diagram(coordinateSystem(extent = {{-148.5,-105},{148.5,105}}, grid = {5,5})), experiment(StopTime = 1, StartTime = 0));
end SinusExample;

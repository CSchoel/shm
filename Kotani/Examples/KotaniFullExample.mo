...
model KotaniFullExample 
  ...
  Kotani.Components.SympatheticSystem symp(v0 = symp_basic_activity, baro_influence = symp_fac_baro, resp_influence = symp_fac_resp) "sympathetic system" annotation(Placement(visible = true, transformation(origin = {-60, 80}, extent = {{-17.1774, -17.1774}, {17.1774, 17.1774}}, rotation = 0)));
  Kotani.Components.ParasympatheticSystem para(v0 = para_basic_activity, baro_influence = para_fac_baro, resp_influence = para_fac_resp, scaling_factor = para_factor) "parasympathetic system" annotation(Placement(visible = true, transformation(origin = {0, 80}, extent = {{-16.7659, -16.7659}, {16.7659, 16.7659}}, rotation = 0)));
  Kotani.Components.HormoneEmission vNeEmit(Tuptake = vNe_Tuptake, prodFac = vNe_fac_symp, triggerDelay = vNe_delay, baseSignal = vNe_base_activity) "emission of vascular Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-20, 40}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  Kotani.Components.NeurotransmitterEmission cNeEmit(Tuptake = cNe_Tuptake, prodFac = cNe_fac_symp, triggerDelay = cNe_delay) "emission of cardiac Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-60, 40}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  Kotani.Components.Basic.HormoneAmout vNeAmount(initialConcentration = conc_vNe) "amount of vascular Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-20, 8}, extent = {{-8.95759, -8.95759}, {8.95759, 8.95759}}, rotation = 0)));
  Kotani.Components.Basic.NeurotransmitterAmount cNeAmount(initialConcentration = conc_cNe) "amount of cardiac Norepinephrine" annotation(Placement(visible = true, transformation(origin = {-60, 8}, extent = {{-8.66127, -8.66127}, {8.66127, 8.66127}}, rotation = 0)));
  ...
  Kotani.Components.Basic.BloodSystem blood(initialPressure = pressure) "main blood system" annotation(Placement(visible = true, transformation(origin = {60, -20}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  Kotani.Components.Baroreceptors baro(p0 = baro_min_pressure, k1 = baro_fac_pressure, k2 = baro_fac_rate) "baroreceptor" annotation(Placement(visible = true, transformation(origin = {60, 20}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  Kotani.Components.SimpleLung lung(initialR = respiratory_phase, Tresp = lung_Tresp, G = lung_fac_baro, nu_trig = lung_baro_min) "the Lung" annotation(Placement(visible = true, transformation(origin = {60, 80}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
equation

...
equation
  ...
  connect(baroreceptors1.signal,neurotransmitterEmission1.trigger) annotation(Line(points = {{49.3488,9.63327},{25.0447,9.63327},{25.0447,61.5385},{25.0447,61.5385}}));
  connect(baroreceptors1.signal,hormoneEmission1.trigger) annotation(Line(points = {{49.3488,9.63327},{70.8408,9.63327},{70.8408,59.3918},{70.8408,59.3918}}));
